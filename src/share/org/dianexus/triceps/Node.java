		...
		try {
			...
			for (int i=0;i<count;++i) {
				...
				if (token == null) 
					token = "";
				switch(++j) {
					case 1: concept = token; break;
					case 2: description = token; break;
					case 3: stepName = "_" + token; break;	// assumes, for now, that input is nubmer without underscore
					case 4: dependencies = token; break;
					case 5: questionRef = token; break;
					case 6: actionType = token; break;
					case 7: action = token; break;
					case 8: {
						answerOptions = token; 
