...
/**
 *     This is the central engine that iterates through the nodes in a schedule producing, e.g., an interview.
 * It also organizes the connection to the display. In the first version, this is an http response as defined in the JSDK.
 */
