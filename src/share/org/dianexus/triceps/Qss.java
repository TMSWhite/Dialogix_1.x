...
public class Qss implements QssConstants {
    ...
    jj_consume_token(RP);
                if (data.containsKey(t.image)) {
                        try {
                                ...
                                stack.push(new Datum(node.getReadback(),Datum.STRING));
                        }
                        catch (Exception e) {
  ...
  final private int[] jj_la1_0 = {0x18000001,0x3d0081e,0x0,0x80000,0x40000,0x200,0x400,0xc000,0xc000,0x33000,0x33000,0x4000018,0x60,0x3d0081e,0x818,0x8000000,0x3d00006,0x8000000,0x0,0x6,0x6,};
  final private int[] jj_la1_1 = {0x0,0x51,0x200,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x51,0x0,0x0,0x51,0x0,0x11,0x0,0x11,};
