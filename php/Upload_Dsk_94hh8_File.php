...
<form enctype="multipart/form-data" action="Upload_Dsk_94hh8_File.php" method="post">
...
if(move_uploaded_file($_FILES['userfile']['tmp_name'], $uploadFile)) {
    echo "The file ".( $_FILES['userfile']['name']). " has been uploaded<br>";
    echo "Click <a href=' http://www.dialogix.org:8080/Wave7-clin/servlet/Dialogix'>here</a>  to go to the Wave 7 site.";
